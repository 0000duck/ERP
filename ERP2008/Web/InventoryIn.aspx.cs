...
namespace ERP.Web
{
    public partial class InventoryIn : System.Web.UI.Page
    {
        ...
        protected void ButtonSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Response.Write("<script language='javascript'>alert('入库信息添加失败！');</script>");
                }
                LoadList();
