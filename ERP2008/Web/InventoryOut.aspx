<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="InventoryOut.aspx.cs" Inherits="ERP.Web.InventoryOut" Title="ERP-出库管理" %>
...
<br />
    ...
    <table align="center" cellpadding="0" cellspacing="0" class="style1">
        <tr>
            <td align="center" >
             出库数：<asp:TextBox ID="TextBoxNumberIn" runat="server"></asp:TextBox>
            </td>
         </tr>
         <tr>
            <td>
         ...
         <tr>
         <td align="center">
          送货人：<asp:TextBox ID="TextBoxSenderMan" runat="server" BackColor="Silver" ReadOnly="True"></asp:TextBox>
         </td>
         </tr>
         <tr>
            <td>
