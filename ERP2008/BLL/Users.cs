...
namespace ERP.BLL
{
	...
	{
		private readonly ERP.DAL.Users dal=new ERP.DAL.Users();
		public Users()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ERP.Model.Users GetModelByCache(int UID)
		{
			...
			return (ERP.Model.Users)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ERP.Model.Users> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ERP.Model.Users> DataTableToList(DataTable dt)
		{
			List<ERP.Model.Users> modelList = new List<ERP.Model.Users>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ERP.Model.Users model;
